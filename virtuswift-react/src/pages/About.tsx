  ...
  return (
    <div className="bg-gray-100">
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-6">
            <div className="industry-card bg-white rounded-xl shadow p-6 flex flex-col items-center">
              <FontAwesomeIcon icon={faHospital} className="text-4xl text-[#3a3dc4] mb-4" />
              <h3 className="text-lg font-semibold text-gray-800">Healthcare</h3>
            </div>
            <div className="industry-card bg-white rounded-xl shadow p-6 flex flex-col items-center">
              <FontAwesomeIcon icon={faUniversity} className="text-4xl text-[#3a3dc4] mb-4" />
              <h3 className="text-lg font-semibold text-gray-800">Finance</h3>
            </div>
            <div className="industry-card bg-white rounded-xl shadow p-6 flex flex-col items-center">
              <FontAwesomeIcon icon={faShoppingBag} className="text-4xl text-[#3a3dc4] mb-4" />
              <h3 className="text-lg font-semibold text-gray-800">Retail</h3>
            </div>
            <div className="industry-card bg-white rounded-xl shadow p-6 flex flex-col items-center">
              <FontAwesomeIcon icon={faIndustry} className="text-4xl text-[#3a3dc4] mb-4" />
              <h3 className="text-lg font-semibold text-gray-800">Manufacturing</h3>
            </div>
            <div className="industry-card bg-white rounded-xl shadow p-6 flex flex-col items-center">
              <FontAwesomeIcon icon={faGraduationCap} className="text-4xl text-[#3a3dc4] mb-4" />
              <h3 className="text-lg font-semibold text-gray-800">Education</h3>
            </div>
            <div className="industry-card bg-white rounded-xl shadow p-6 flex flex-col items-center">
              <FontAwesomeIcon icon={faTruck} className="text-4xl text-[#3a3dc4] mb-4" />
        ...
        <section className="mb-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="vision-mission-card bg-white rounded-xl shadow p-8 flex flex-col items-center">
              <FontAwesomeIcon icon={faBullseye} className="text-4xl text-[#3a3dc4] mb-4" />
            ...
            <div className="vision-mission-card bg-white rounded-xl shadow p-8 flex flex-col items-center">
              <FontAwesomeIcon icon={faRocket} className="text-4xl text-[#3a3dc4] mb-4" />
            ...
            <div className="vision-mission-card bg-white rounded-xl shadow p-8 flex flex-col items-center">
              <FontAwesomeIcon icon={faHandshake} className="text-4xl text-[#3a3dc4] mb-4" />
        ...
        <section className="bg-[#3a3dc4] text-white py-16 rounded-lg">
          <div className="text-center">
            ...
            <div className="flex justify-center gap-4">
              <Link
                to="/contact"
                className="bg-white text-[#3a3dc4] px-6 py-2 rounded-lg hover:bg-gray-100 transition-colors"
              >
                Request a Consultation
              </Link>
              <Link
                to="/contact"
                className="border-2 border-white text-white px-6 py-2 rounded-lg hover:bg-white hover:text-[#3a3dc4] transition-colors"
              >
                Learn More
              </Link>
            </div>
