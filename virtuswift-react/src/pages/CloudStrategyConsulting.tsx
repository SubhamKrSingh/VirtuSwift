  ...
  'Why Cloud?': (
    <div className="flex flex-col md:flex-row gap-8 mb-12 items-center">
      <div className="md:w-1/2">
        <h3 className="text-2xl font-extrabold text-[#3a3dc4] mb-2 uppercase tracking-widest">WHY CLOUD?</h3>
        <h2 className="text-4xl md:text-5xl font-black mb-4 text-gray-800 leading-tight">Cloud: The Foundation for Innovation, Scale, and Resilience</h2>
  ...
  'Why VirtuSwift?': (
    <div className="transition-all duration-1000 delay-400">
      <div className="text-center mb-8">
        ...
        <h2 className="text-4xl md:text-5xl font-black mb-4 text-gray-800 leading-tight">Why Companies Trust VirtuSwift</h2>
      </div>
    ...
    <div className="bg-gray-100">
      ...
      <div className="max-w-4xl mx-auto mb-20">
        <div className="text-center mb-6">
          ...
          <h2 className="text-4xl md:text-5xl font-black mb-4 text-gray-800 leading-tight">How VirtuSwift Delivers Your Cloud Success</h2>
        </div>
      ...
      <div className="text-center mt-12 pb-12">
        ...
        <div className="mb-4">
          ...
          <h2 className="text-4xl md:text-5xl font-black mb-4 text-gray-800 leading-tight text-center">Ready to Begin Your Cloud Journey?</h2>
        </div>
