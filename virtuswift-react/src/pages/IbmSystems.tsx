...
const sliderImages = [
  {
    ...
    title: 'Revolutionizing Enterprise Systems with VirtuSwift IBM Expertise',
    desc: 'Transform your enterprise infrastructure with innovative IBM technology and consulting.'
  },
  {
    url: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71',
    title: '',
      ...
      <div className="container mx-auto px-4 py-8 flex-1">
        ...
        {activeTab === 'Overview' && (
          <div className={`flex flex-col md:flex-row gap-8 mb-12 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <div className="md:w-1/2">
              <h2 className="text-3xl font-bold mb-4">Transforming Enterprise Infrastructure with VirtuSwift IBM Expertise</h2>
              <p className="text-gray-600 mb-6">
                At VirtuSwift, we deliver tailored IBM solutions to revolutionize enterprise systems. Our expertise in IBM infrastructure, cloud services, and enterprise software empowers organizations to enhance reliability and operational efficiency.
              </p>
              <Link to="/contact?service=ibm" className="inline-block bg-[#3a3dc4] text-white px-6 py-2 rounded-lg hover:bg-[#008BCF] transition-all duration-300 hover:scale-105 hover:shadow-lg">Explore Now</Link>
            </div>
            <div className="md:w-1/2">
              <img src="https://images.unsplash.com/photo-1551288049-bebda4e38f71" alt="IBM IT Technology" className="w-full h-64 object-cover rounded-lg transition-all duration-500 hover:shadow-xl hover:scale-105" />
            </div>
          </div>
        )}
        {/* Capabilities Tab */}
        {activeTab === 'Capabilities' && (
          <div className={`mb-12 transition-all duration-1000 delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            <h2 className="text-3xl font-bold mb-4">Revolutionize Enterprise Systems with VirtuSwift</h2>
            <div className="space-y-8">
              <div className="flex flex-col md:flex-row gap-6">
                {[
                  {
                    title: 'IBM Infrastructure Management',
                    description: 'Comprehensive IBM infrastructure management with performance optimization and monitoring.'
                  },
                  {
                    title: 'IBM Cloud Services',
                    description: 'Seamless migration to IBM Cloud with enterprise-grade security and reliability.'
                  },
                  {
                    title: 'IBM Enterprise Software',
                    description: 'Implementation and optimization of IBM enterprise software solutions.'
                  }
        ...
        {activeTab === 'Benefits' && (
          <div className={`transition-all duration-1000 delay-400 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <h2 className="text-3xl font-bold mb-8">A Future-Ready Enterprise Ecosystem</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                { icon: faCogs, title: "Certified Experts", text: "Our team is trained in advanced IBM technologies and enterprise systems." },
                { icon: faSyncAlt, title: "Proven Results", text: "We've successfully implemented IBM solutions for global organizations." },
                { icon: faGraduationCap, title: "Continuous Innovation", text: "Our experts stay ahead of IBM technology trends and updates." },
                { icon: faCloud, title: "Scalable Solutions", text: "Build enterprise systems that grow with your business and operational needs." },
                { icon: faShieldAlt, title: "Enterprise Security", text: "Ensure secure IBM implementations with industry-standard security practices." },
                { icon: faHandshake, title: "Strategic Partnerships", text: "Collaborate with IBM and top tech providers for innovative solutions." }
              ].map((benefit, index) => (
                <div 
                  key={benefit.title}
            ...
            <div className="space-y-12 mt-12">
              <div className={`flex flex-col md:flex-row gap-8 transition-all duration-1000 delay-600 hover:shadow-2xl hover:scale-105 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                <div className="md:w-1/2">
                  <h3 className="text-xl font-semibold mb-4">Proactive Support for Enterprise Excellence</h3>
                  <p className="text-gray-600 mb-4">
                    Our robust support system resolves 95% of IBM challenges swiftly, backed by continuous training to address evolving enterprise needs and platform updates.
                  </p>
                  <Link to="/contact?service=ibm" className="inline-block bg-[#3a3dc4] text-white px-6 py-2 rounded-lg hover:bg-[#008BCF] transition-all duration-300 hover:scale-105 hover:shadow-lg">Get Support</Link>
                </div>
                <div className="md:w-1/2">
                  <img src="https://images.unsplash.com/photo-1551288049-bebda4e38f71" alt="IBM IT Support" className="w-full h-64 object-cover rounded-lg transition-all duration-500 hover:shadow-xl hover:scale-105" />
                </div>
              </div>
              <div className={`flex flex-col md:flex-row gap-8 transition-all duration-1000 delay-800 hover:shadow-2xl hover:scale-105 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                <div className="md:w-1/2">
                  ...
                  <p className="text-gray-600 mb-4">
                    Since 2010, VirtuSwift has partnered with IBM and leading tech providers to deliver innovative enterprise solutions, improving reliability and operational efficiency.
                  </p>
                  <Link to="/contact?service=ibm" className="inline-block bg-[#3a3dc4] text-white px-6 py-2 rounded-lg hover:bg-[#008BCF] transition-all duration-300 hover:scale-105 hover:shadow-lg">Collaborate with Us</Link>
                </div>
                <div className="md:w-1/2">
                  ...
                  {[
                    {
                      ...
                      title: "IBM Enterprise Insights",
                      description: "Learn how VirtuSwift enhances enterprise infrastructure with innovative IBM solutions."
                    },
                    {
                      image: "https://images.unsplash.com/photo-1551288049-bebda4e38f71",
                      title: "Enterprise Technology Trends",
                      description: "Stay updated with the latest IBM technology trends and best practices."
                    },
                    {
                      image: "https://images.unsplash.com/photo-1551288049-bebda4e38f71",
                      title: "Enterprise Infrastructure Management",
                      description: "Discover how IBM technology improves enterprise reliability and operational efficiency."
                    }
                  ].map((resource, index) => (
                    <div 
                      key={resource.title}
