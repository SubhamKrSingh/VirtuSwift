      ...
      <div className="container mx-auto px-4 py-8">
        {activeTab === 'Why Metaverse Solutions?' && (
          <>
            ...
            <div className="max-w-6xl mx-auto mb-16 px-4">
              <div className="flex flex-col md:flex-row items-center gap-12">
                <div className="flex-1 w-full md:pr-8">
                  <h2 className="text-3xl md:text-4xl font-extrabold mb-4 text-gray-900">❓ Why Metaverse Solutions?</h2>
            ...
            <div className="max-w-6xl mx-auto mb-16 px-4">
              <h2 className="text-2xl font-bold mb-6 text-gray-900 text-center">🚀 How Metaverse & XR Drive Business Value</h2>
        ...
        {activeTab === 'Our Services' && (
          <>
            ...
            <div className="max-w-6xl mx-auto mb-16 px-4">
              <h2 className="text-2xl font-bold mb-6 text-gray-900 text-center">Our Metaverse & Immersive Technology Services</h2>
            ...
            <div className="max-w-6xl mx-auto mb-16 px-4">
              <h2 className="text-2xl font-bold mb-6 text-gray-900 text-center">How VirtuSwift Builds Immersive Ecosystems</h2>
              <div className="flex flex-col md:flex-row gap-6 mt-6 justify-center">
                {[
                  { step: '1️⃣', title: 'Explore & Ideate', desc: 'XR workshops to define use cases, business goals, and platform requirements.' },
                  { step: '2️⃣', title: 'Design & Build', desc: 'UX/UI prototyping, 3D asset creation, and environment building with iterative collaboration.' },
                  { step: '3️⃣', title: 'Integrate & Deploy', desc: 'XR is integrated with enterprise systems and deployed across user roles and platforms.' },
                  { step: '4️⃣', title: 'Support & Optimize', desc: 'We offer post-deployment tuning, device testing, and ongoing content management.' },
                ].map((s) => (
          ...
          <>
            ...
            <div className="max-w-6xl mx-auto mb-16 px-4">
              <div className="flex flex-col md:flex-row items-center gap-12 bg-white rounded-xl shadow p-8">
                <div className="flex-1 w-full md:pr-8">
                  <h2 className="text-3xl md:text-4xl font-extrabold mb-4 text-gray-900">Why VirtuSwift for Metaverse & XR Services?</h2>
                  ...
                  <ul className="space-y-3 mb-6">
                    ...
                    <li className="flex items-center gap-3 text-gray-800 text-base"><FontAwesomeIcon icon={faRocket} className="text-[#008BCF] text-xl" /> 🚀 3D-Ready Cloud Infrastructure: GPU-powered, latency-optimized, and built for immersive scale.</li>
                    <li className="flex items-center gap-3 text-gray-800 text-base"><FontAwesomeIcon icon={faSync} className="text-[#f05a28] text-xl" /> 🔗 Enterprise-Grade Integration: We integrate XR solutions with your ERP, CRM, cloud stack, and security layers.</li>
                    <li className="flex items-center gap-3 text-gray-800 text-base"><FontAwesomeIcon icon={faGlobe} className="text-[#008BCF] text-xl" /> 📱 Multi-Platform Compatibility: Builds for Oculus, HoloLens, Android/iOS AR, WebXR, and desktop VR.</li>
            ...
            <div className="text-center mt-16 pb-16">
              <h2 className="text-3xl font-extrabold mb-4 text-gray-900">Ready to Enter the Metaverse?</h2>
