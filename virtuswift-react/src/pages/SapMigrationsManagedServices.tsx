...
import { faCloud, faCheckCircle, faRocket, faLightbulb, faDatabase, faLock, faChartBar, faServer, faCogs, faShieldAlt } from '@fortawesome/free-solid-svg-icons';
import { Link } from 'react-router-dom';

const sapServices = [
  'SAP Landscape Assessment & Migration Roadmap',
  'Infrastructure & Database Lift-and-Shift',
  'Hybrid/Multi-Cloud Deployment for SAP Workloads',
  'Post-Migration Optimization & SLA Management',
  '24/7 SAP Basis Support and Monitoring',
  'Performance Tuning and Capacity Planning',
];

const advantageList = [
  'Elastic, Scalable Cloud Infrastructure',
  'Cost-Efficient Resource Utilization',
  'Simplified SAP Operations',
...
export default function SapMigrationsManagedServices() {
  return (
    <div className="bg-gray-100 min-h-screen">
      {/* Hero Section */}
      <section className="relative w-full h-[320px] flex items-center justify-center bg-cover bg-center" style={{ backgroundImage: 'url(/assets/cloudmigration1.png)' }}>
        <div className="absolute inset-0 bg-black bg-opacity-60 flex items-center justify-center">
          <div className="text-center text-white max-w-2xl px-4">
            <h1 className="text-3xl md:text-4xl font-bold mb-4">Move SAP to the Cloud—Without the Complexity</h1>
            <p className="text-lg md:text-xl mb-6">VirtuSwift delivers end-to-end SAP cloud migration strategies—ensuring resilience, compliance, and performance at every step.</p>
            <Link to="/contact" className="inline-block bg-[#3a3dc4] text-white px-8 py-3 rounded-lg hover:bg-[#f05a28] transition-all duration-300 hover:scale-105 hover:shadow-lg text-lg font-semibold">Plan Your SAP Cloud Move</Link>
          </div>
        </div>
      </section>

      {/* Why Choose VirtuSwift for SAP Cloud Migration? */}
          ...
          <div className="max-w-6xl mx-auto mb-10 px-4">
            <div className="flex flex-col md:flex-row items-center md:items-center gap-12">
              ...
              <div className="flex-1 w-full md:pr-8">
                <h2 className="text-2xl font-bold mb-6 text-gray-900 flex items-center gap-2"><FontAwesomeIcon icon={faRocket} className="text-[#3a3dc4]" /> 🚀 Why Choose VirtuSwift for SAP Cloud Migration?</h2>
                <p className="text-gray-700 mb-6">We've helped global enterprises modernize their SAP environments—securely and seamlessly.</p>
                ...
                <div className="text-center mt-8">
                  <Link to="/contact" className="inline-block bg-[#3a3dc4] text-white px-8 py-4 rounded-lg font-semibold shadow-lg hover:bg-[#f05a28] hover:scale-105 transition text-lg">Schedule Cloud Assessment</Link>
                </div>
              </div>
              {/* Right: Image */}
              <div className="flex-shrink-0 w-full md:w-1/2 flex justify-center md:justify-end">
                <img src="/assets/cloudmigration4.png" alt="SAP Cloud Migration" className="max-w-2xl w-full h-auto object-cover rounded-xl shadow-lg" style={{ maxHeight: '320px' }} />
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-6xl mx-auto mb-10 px-4">
            <div className="flex flex-col md:flex-row items-center md:items-center gap-12">
              ...
              <div className="flex-1 w-full md:pr-8">
                ...
                <p className="text-gray-700 mb-6">We simplify the complex so your SAP runs smarter in the cloud.</p>
                ...
                <div className="text-center mt-8">
                  <span className="inline-block bg-[#3a3dc4] text-white px-8 py-4 rounded-lg font-semibold shadow-lg text-lg">Elevate SAP to the Cloud →</span>
                </div>
              </div>
              {/* Right: Image */}
              <div className="flex-shrink-0 w-full md:w-1/2 flex justify-center md:justify-end">
                <img src="/assets/cloudmigration5.png" alt="VirtuSwift SAP Advantage" className="max-w-2xl w-full h-auto object-cover rounded-xl shadow-lg" style={{ maxHeight: '320px' }} />
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-3xl mx-auto mb-10 text-center">
          ...
          <p className="text-lg text-gray-600 mb-6">Let VirtuSwift guide your SAP journey to the cloud—securely, smoothly, and strategically.</p>
          <Link to="/contact" className="inline-block bg-[#3a3dc4] text-white px-8 py-4 rounded-lg font-semibold shadow-lg hover:bg-[#f05a28] hover:scale-105 transition text-lg">Schedule Your SAP Consultation</Link>
        </div>
      </div>
