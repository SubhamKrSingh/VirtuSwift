    ...
    <div className="bg-gray-100 min-h-screen flex flex-col">
      ...
      <div className="container mx-auto px-4 py-8 flex-1">
          ...
          <>
            <div className={`flex flex-col md:flex-row gap-8 mb-12 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
              <div className="md:w-1/2">
                <h2 className="text-3xl font-bold mb-4">❓ Why SAP Services?</h2>
            ...
            <div className={`mb-12 transition-all duration-1000 delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                <div className="bg-white p-6 rounded-2xl shadow-md text-center">
                  <h4 className="text-lg font-semibold text-[#3a3dc4] mb-2">⚙️ Real-Time Data Visibility</h4>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="bg-white p-6 rounded-2xl shadow-md text-center">
                  <h4 className="text-lg font-semibold text-[#3a3dc4] mb-2">🛡️ Security & Compliance</h4>
        ...
        {activeTab === 'Capabilities' && (
          <div className={`mb-12 transition-all duration-1000 delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <h3 className="text-xl font-semibold text-[#3a3dc4] mb-2">🛠️ Our SAP Service Offerings</h3>
          ...
          <div className={`transition-all duration-1000 delay-400 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            <div className="mb-12">
              ...
              <div className="flex flex-col md:flex-row gap-6 justify-center">
                {[
                  { step: '1️⃣', title: 'Assess & Strategize', desc: 'Full landscape analysis + goal alignment = transformation roadmap.' },
                  { step: '2️⃣', title: 'Design & Architect', desc: 'Cloud-first, scalable, and secure SAP system designs customized to your use case.' },
                  { step: '3️⃣', title: 'Migrate & Integrate', desc: 'We move your SAP stack (greenfield, brownfield, or hybrid) with no friction.' },
                  { step: '4️⃣', title: 'Optimize & Evolve', desc: 'Post-deployment tuning, performance scaling, and SLA-driven AMS support.' }
                ].map((process, index) => (
            ...
            <div className="bg-gray-50 py-12 mt-12">
              <div className="container mx-auto px-4">
                <h2 className="text-3xl font-bold mb-8 text-center">🔗 Related Services from VirtuSwift</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                  {[
                    ...
                    { title: "⚙️ Software Development", desc: "Enterprise-grade SaaS, mobile, and web solutions.", link: "/services/application-web-development" },
