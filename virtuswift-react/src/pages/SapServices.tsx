...
const sliderImages = [
  {
    ...
    title: 'Revolutionizing SAP Solutions with VirtuSwift IT Expertise',
    desc: 'Transform your business processes with innovative SAP technology and consulting.'
  },
  {
    url: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71',
    title: '',
      ...
      <div className="container mx-auto px-4 py-8 flex-1">
        ...
        {activeTab === 'Overview' && (
          <div className={`flex flex-col md:flex-row gap-8 mb-12 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <div className="md:w-1/2">
              <h2 className="text-3xl font-bold mb-4">Transforming Business Processes with VirtuSwift SAP Expertise</h2>
              <p className="text-gray-600 mb-6">
                At VirtuSwift, we deliver tailored SAP solutions to revolutionize business operations. Our expertise in SAP implementation, customization, and optimization empowers organizations to enhance efficiency and drive growth.
              </p>
              <Link to="/contact?service=sap" className="inline-block bg-[#3a3dc4] text-white px-6 py-2 rounded-lg hover:bg-[#008BCF] transition-all duration-300 hover:scale-105 hover:shadow-lg">Explore Now</Link>
            </div>
            <div className="md:w-1/2">
        ...
        {activeTab === 'Capabilities' && (
          <div className={`mb-12 transition-all duration-1000 delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            <h2 className="text-3xl font-bold mb-4">Revolutionize Business Processes with VirtuSwift</h2>
            <div className="space-y-8">
              <div className="flex flex-col md:flex-row gap-6">
                {[
                  {
                    title: 'SAP Implementation',
                    description: 'End-to-end SAP implementation services with best practices and industry expertise.'
                  },
                  {
                    title: 'SAP Customization',
                    description: 'Tailored SAP solutions to meet specific business requirements and workflows.'
                  },
                  {
                    title: 'SAP Optimization',
                    description: 'Performance tuning and optimization of existing SAP systems for maximum efficiency.'
                  }
        ...
        {activeTab === 'Benefits' && (
          <div className={`transition-all duration-1000 delay-400 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <h2 className="text-3xl font-bold mb-8">A Future-Ready SAP Ecosystem</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                { icon: faCogs, title: "Certified Experts", text: "Our team is trained in advanced SAP technologies and business processes." },
                { icon: faSyncAlt, title: "Proven Results", text: "We've successfully implemented SAP solutions for global organizations." },
                { icon: faGraduationCap, title: "Continuous Innovation", text: "Our experts stay ahead of SAP technology trends and updates." },
                { icon: faCloud, title: "Scalable Solutions", text: "Build SAP systems that grow with your business and operational needs." },
                { icon: faShieldAlt, title: "Data Security", text: "Ensure secure SAP implementations with industry-standard security practices." },
                { icon: faHandshake, title: "Strategic Partnerships", text: "Collaborate with SAP and top tech providers for innovative solutions." }
              ].map((benefit, index) => (
                <div 
                  key={benefit.title}
            ...
            <div className="space-y-12 mt-12">
              <div className={`flex flex-col md:flex-row gap-8 transition-all duration-1000 delay-600 hover:shadow-2xl hover:scale-105 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                <div className="md:w-1/2">
                  <h3 className="text-xl font-semibold mb-4">Proactive Support for SAP Excellence</h3>
                  <p className="text-gray-600 mb-4">
                    Our robust support system resolves 95% of SAP challenges swiftly, backed by continuous training to address evolving business needs and system updates.
                  </p>
                  <Link to="/contact?service=sap" className="inline-block bg-[#3a3dc4] text-white px-6 py-2 rounded-lg hover:bg-[#008BCF] transition-all duration-300 hover:scale-105 hover:shadow-lg">Get Support</Link>
                </div>
                <div className="md:w-1/2">
                  <img src="https://images.unsplash.com/photo-1551288049-bebda4e38f71" alt="SAP IT Support" className="w-full h-64 object-cover rounded-lg transition-all duration-500 hover:shadow-xl hover:scale-105" />
                </div>
              </div>
              <div className={`flex flex-col md:flex-row gap-8 transition-all duration-1000 delay-800 hover:shadow-2xl hover:scale-105 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                <div className="md:w-1/2">
                  ...
                  <p className="text-gray-600 mb-4">
                    Since 2010, VirtuSwift has partnered with SAP and leading tech providers to deliver innovative business solutions, improving operational efficiency and process optimization.
                  </p>
                  <Link to="/contact?service=sap" className="inline-block bg-[#3a3dc4] text-white px-6 py-2 rounded-lg hover:bg-[#008BCF] transition-all duration-300 hover:scale-105 hover:shadow-lg">Collaborate with Us</Link>
                </div>
                <div className="md:w-1/2">
                  ...
                  {[
                    {
                      ...
                      title: "SAP Implementation Insights",
                      description: "Learn how VirtuSwift enhances business processes with innovative SAP solutions."
                    },
                    {
                      image: "https://images.unsplash.com/photo-1551288049-bebda4e38f71",
                      title: "SAP Technology Trends",
                      description: "Stay updated with the latest SAP technology trends and best practices."
                    },
                    {
                      image: "https://images.unsplash.com/photo-1551288049-bebda4e38f71",
                      title: "Business Process Optimization",
                      description: "Discover how SAP technology improves business efficiency and operations."
                    }
                  ].map((resource, index) => (
                    <div 
                      key={resource.title}
